...
# define data(ctx) ((UCI_AES_HMAC_SHA1 *)UCI_CIPHER_CTX_get_cipher_data(ctx))

static int aesni_cbc_hmac_sha1_init_key(UCI_CIPHER_CTX *ctx,
                                        const unsigned char *inkey,
                                        const unsigned char *iv, int enc)
{
    UCI_AES_HMAC_SHA1 *key = data(ctx);
    int ret;
...
static size_t tls1_1_multi_block_encrypt(UCI_AES_HMAC_SHA1 *key,
                                         unsigned char *out,
                                         const unsigned char *inp,
...
static int aesni_cbc_hmac_sha1_cipher(UCI_CIPHER_CTX *ctx, unsigned char *out,
...
static int aesni_cbc_hmac_sha1_ctrl(UCI_CIPHER_CTX *ctx, int type, int arg,
                                    void *ptr)
{
    UCI_AES_HMAC_SHA1 *key = data(ctx);
...
# if !defined(OPENSSL_NO_MULTIBLOCK)
    ...
    case UCI_CTRL_TLS1_1_MULTIBLOCK_AAD:
        {
            UCI_CTRL_TLS1_1_MULTIBLOCK_PARAM *param =
    ...
    case UCI_CTRL_TLS1_1_MULTIBLOCK_DECRYPT:
# endif
    default:
        return -1;
    }
...
static UCI_CIPHER aesni_128_cbc_hmac_sha1_cipher = {
...
# endif
    ...
    UCI_CIPH_CBC_MODE | UCI_CIPH_FLAG_DEFAULT_ASN1 |
        UCI_CIPH_FLAG_AEAD_CIPHER | UCI_CIPH_FLAG_TLS1_1_MULTIBLOCK,
    UCI_ORIG_GLOBAL,
    aesni_cbc_hmac_sha1_init_key,
    aesni_cbc_hmac_sha1_cipher,
    NULL,
    sizeof(UCI_AES_HMAC_SHA1),
    UCI_CIPH_FLAG_DEFAULT_ASN1 ? NULL : UCI_CIPHER_set_asn1_iv,
    UCI_CIPH_FLAG_DEFAULT_ASN1 ? NULL : UCI_CIPHER_get_asn1_iv,
    aesni_cbc_hmac_sha1_ctrl,
    NULL
};

static UCI_CIPHER aesni_256_cbc_hmac_sha1_cipher = {
...
const UCI_CIPHER *UCI_aes_128_cbc_hmac_sha1(void)
{
    return (OPENSSL_ia32cap_P[1] & AESNI_CAPABLE ?
            &aesni_128_cbc_hmac_sha1_cipher : NULL);
}

const UCI_CIPHER *UCI_aes_256_cbc_hmac_sha1(void)
{
    return (OPENSSL_ia32cap_P[1] & AESNI_CAPABLE ?
