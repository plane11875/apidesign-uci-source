...
IMPLEMENT_LEGACY_UCI_MD_METH_LC(blake2s_int, blake2s)
IMPLEMENT_LEGACY_UCI_MD_METH_LC(blake2b_int, blake2b)

static const UCI_MD blake2b_md = {
    NID_blake2b512,
    0,
    BLAKE2B_DIGEST_LENGTH,
    0,
    UCI_ORIG_GLOBAL,
    LEGACY_UCI_MD_METH_TABLE(blake2b_int_init, blake2b_int_update,
                             blake2b_int_final, NULL, BLAKE2B_BLOCKBYTES),
};

const UCI_MD *UCI_blake2b512(void)
{
    return &blake2b_md;
}

static const UCI_MD blake2s_md = {
    NID_blake2s256,
    0,
    BLAKE2S_DIGEST_LENGTH,
    0,
    UCI_ORIG_GLOBAL,
    LEGACY_UCI_MD_METH_TABLE(blake2s_int_init, blake2s_int_update,
                             blake2s_int_final, NULL, BLAKE2S_BLOCKBYTES),
};

const UCI_MD *UCI_blake2s256(void)
{
    return &blake2s_md;
}
